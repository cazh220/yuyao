<?php /* Smarty version 2.6.10, created on 2017-08-13 15:46:10
...
<script src="templates/uploadify/scripts/jquery.uploadify.js" type="text/javascript"></script>

<!-- svg图表  supports Firefox 3.0+, Safari 3.0+, Chrome 5.0+, Opera 9.5+ and Internet Explorer 6.0+ -->
<script type="text/javascript" src="templates/chart/raphael.js"></script>
<script type="text/javascript" src="templates/chart/g.raphael.js"></script>
<script type="text/javascript" src="templates/chart/g.bar.js"></script>
<script type="text/javascript" src="templates/chart/g.line.js"></script>
<script type="text/javascript" src="templates/chart/g.pie.js"></script>
<script type="text/javascript" src="templates/chart/g.dot.js"></script>

<script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=6PYkS1eDz5pMnyfO0jvBNE0F"></script>
<script type="text/javascript" src="http://api.map.baidu.com/library/Heatmap/2.0/src/Heatmap_min.js"></script>

<script src="templates/js/dwz.core.js" type="text/javascript"></script>
<script src="templates/js/dwz.util.date.js" type="text/javascript"></script>
<script src="templates/js/dwz.validate.method.js" type="text/javascript"></script>
<script src="templates/js/dwz.barDrag.js" type="text/javascript"></script>
<script src="templates/js/dwz.drag.js" type="text/javascript"></script>
<script src="templates/js/dwz.tree.js" type="text/javascript"></script>
<script src="templates/js/dwz.accordion.js" type="text/javascript"></script>
<script src="templates/js/dwz.ui.js" type="text/javascript"></script>
<script src="templates/js/dwz.theme.js" type="text/javascript"></script>
<script src="templates/js/dwz.switchEnv.js" type="text/javascript"></script>
<script src="templates/js/dwz.alertMsg.js" type="text/javascript"></script>
<script src="templates/js/dwz.contextmenu.js" type="text/javascript"></script>
<script src="templates/js/dwz.navTab.js" type="text/javascript"></script>
<script src="templates/js/dwz.tab.js" type="text/javascript"></script>
<script src="templates/js/dwz.resize.js" type="text/javascript"></script>
<script src="templates/js/dwz.dialog.js" type="text/javascript"></script>
<script src="templates/js/dwz.dialogDrag.js" type="text/javascript"></script>
<script src="templates/js/dwz.sortDrag.js" type="text/javascript"></script>
<script src="templates/js/dwz.cssTable.js" type="text/javascript"></script>
<script src="templates/js/dwz.stable.js" type="text/javascript"></script>
<script src="templates/js/dwz.taskBar.js" type="text/javascript"></script>
<script src="templates/js/dwz.ajax.js" type="text/javascript"></script>
<script src="templates/js/dwz.pagination.js" type="text/javascript"></script>
<script src="templates/js/dwz.database.js" type="text/javascript"></script>
<script src="templates/js/dwz.datepicker.js" type="text/javascript"></script>
<script src="templates/js/dwz.effects.js" type="text/javascript"></script>
<script src="templates/js/dwz.panel.js" type="text/javascript"></script>
<script src="templates/js/dwz.checkbox.js" type="text/javascript"></script>
<script src="templates/js/dwz.history.js" type="text/javascript"></script>
<script src="templates/js/dwz.combox.js" type="text/javascript"></script>
<script src="templates/js/dwz.file.js" type="text/javascript"></script>
...
//		loginUrl:"login.html",	// 跳到登录页面
		...
		callback:function(){
			initEnv();
			$("#themeList").theme({themeBase:"templates/themes"}); // themeBase 相对于index页面的主题base路径
		}
	});
});
'; ?>
